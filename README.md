...
Extracts i18n calls and generates the appropriate localization files and keys at the `locales` folder.<br />

See more at the library's repository [here](https://github.com/i18next/i18next-parser)
